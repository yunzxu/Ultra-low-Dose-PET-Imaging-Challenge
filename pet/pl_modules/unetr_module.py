...
from pet.models import UNETR,EDSR3D,UNetPlusPlus_nest3_3d,UNETR_NoBN,UNet_nest3_3d,Convnext3D,UNet3plus_nest3_3d_depth3_linear,Convnext3D_stem
import pet
import numpy as np
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.net = EDSR3D(
            ...
            n_blocks=8,
            res_scale=0.1)
        # self.net=UNetPlusPlus_nest3_3d(
        #         in_channels=1,
        #         out_channels=1,
        #         n1=8,)
...
class ConvNext3DModule(pl.LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.net = Convnext3D(ngf=16,depths=[3,3,3,3])
        # self.net = UNETR(
        #     input_dim=1, 
        #     output_dim=1,
        # )
...
class UNETppModule(pl.LightningModule):
    """
    UNet++ training module.
    This can be used to train UNet++ networks from the paper:
    UNet++: A Nested U-Net Architecture for Medical Image Segmentation
...
class UNET3PlusModule(pl.LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.net=UNet3plus_nest3_3d_depth3_linear(
                in_channels=1,
                out_channels=1,
                n1=32,
                filters_cat=32,
...
class ConvNext3DStemModule(pl.LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.net = Convnext3D_stem(ngf=48,depths=[3,3,9,3])
